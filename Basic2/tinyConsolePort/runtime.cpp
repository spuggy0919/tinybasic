...
int8_t odd = OSERIAL; // default output stream in interactive mode spuggy0919
...
/*
 * ESPLITTLEFS tested on ESP8266 and ESP32 
 * spuggy0919 TinyConsole 
 * supports formating in BASIC
 */ 
#ifdef ESPLITTLEFS
#define FILESYSTEMDRIVER
...
/* the displays */
  ...
  dspbegin();
#endif
#if defined(ARDUINOVGA) || defined(POSIXFRAMEBUFFER) || defined(HTTPWSVGA)
/* spuggy0919 HTTWSVGA this for http websocket Canvas*/
 ...
 */
#ifndef HTTPWSSERIAL  /*spuggy0919 it should be actived by HTTPWSSERIAL*/ 
...
void filewrite(char c) {
	...
	if (ofile) fputc(c, ofile); else ioer=1;
#endif
...
#endif //#ifndef HTTPWSSERIAL *spuggy0919* port here disable
...
void wireouts(char *b, uint8_t l) {
 ...
 //   for(z.a=0; z.a<l; z.a++) Wire.write(b[z.a]);  
    for(int i=0; i<l; i++) Wire.write(b[i]);   /* spuggy0919 compiler error spuggy z.a no in scope*/
#else
    Wire.write(b, l);
#endif
    ioer=Wire.endTransmission(); 

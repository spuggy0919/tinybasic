...
#undef  ARDUINOPICOSERIAL
#undef ESPSPIFFS
#define ESPLITTLEFS				/*spuggy0919 add for tinyconsole*/
#define HTTPWSSERIAL	/*spuggy0919 add for tinyconsole*/
#define DISPLAYCANSCROLL
#undef ARDUINOILI9488 /*spuggy0919 undef for tinyconsole*/
#undef ARDUINOSSD1306 /*spuggy0919 undef for tinyconsole*/
 ...
 * supports formating in BASIC spuggy0919
 */ 
#ifdef ESPLITTLEFS
#define FILESYSTEMDRIVER
#endif
...
/*
 * HTTPWSVGA T display code with UTFT.
 * Tested witth TinyConsole. 
 *	it is mainly intended for ESP32
 * See also 
  * https://github.com/spuggy0919/tinyConsole
 */
#ifdef HTTPWSVGA
#undef DISPLAYDRIVER
#define DISPLAYHASCOLOR 
 ...
 */
#define HASARGS /*spuggy0919 TINYCONSOLE with ARGS*/
